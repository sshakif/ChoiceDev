                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vam">
                                <div data-bs-toggle="modal" @if ($items->file_path) data-bs-target="#ViewImg{{ $key }}"
                                    @endif
                                    style="width: 120px; height:80px; overflow:hidden; border-radius:8px; cursor:
                                    pointer;">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="d-flex mt-3  gap-1">
                                            ...
                                            <form action="{{ route('category.delete', $items->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                        ...
                        {{-- view img model --}}
                        <div class="modal fade" id="ViewImg{{ $key }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="mb20 mt-2">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <textarea name="note" rows="3" class="mb-3 d-none" name="body"
