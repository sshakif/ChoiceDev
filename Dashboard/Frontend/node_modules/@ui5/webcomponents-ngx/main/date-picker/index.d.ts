...
import { default as DatePicker, DatePickerChangeEventDetail, DatePickerInputEventDetail, DatePickerValueStateChangeEventDetail } from '@ui5/webcomponents/dist/DatePicker.js';
...
declare class DatePickerComponent {
  ...
  If not set, the calendar type of the global configuration is used.
          */
    primaryCalendarType: 'Gregorian' | 'Islamic' | 'Japanese' | 'Buddhist' | 'Persian' | undefined;
    /**
          Defines the secondary calendar type.
  If not set, the calendar will only show the primary calendar type.
          */
    secondaryCalendarType: 'Gregorian' | 'Islamic' | 'Japanese' | 'Buddhist' | 'Persian' | undefined;
    /**
