...
const Loader = forwardRef((props, ref) => {
    ...
    return (_jsx("div", { ref: ref, className: loaderClasses, "data-component-name": "Loader", "aria-busy": "true", role: "progressbar", title: i18nBundle.getText(PLEASE_WAIT), slot: slot, style: {
            ...style,
            backgroundSize
        }, ...rest }));
});
