...
export const OverflowPopover = (props) => {
    ...
    return (_jsxs(OverflowPopoverContextProvider, { value: { inPopover: true }, children: [overflowButton ? (cloneElement(overflowButton, { onClick: clonedOverflowButtonClick })) : (_jsx(ToggleButton, { ref: toggleBtnRef, design: ButtonDesign.Transparent, icon: iconOverflow, onClick: handleToggleButtonClick, pressed: pressed, accessibleName: showMoreText, tooltip: showMoreText, "data-component-name": "ToolbarOverflowButton" })), canRenderPortal &&
                createPortal(_jsx(Popover, { "data-component-name": "ToolbarOverflowPopover", className: clsx(classes.popover, isPhone && classes.popoverPhone), placement: PopoverPlacement.Bottom, ref: componentRef, open: pressed, onClose: handleClose, onBeforeOpen: handleBeforeOpen, onOpen: handleAfterOpen, hideArrow: true, accessibleRole: accessibleRole, children: _jsx("div", { className: classes.popoverContent, ref: overflowContentRef, role: a11yConfig?.overflowPopover?.contentRole, "data-component-name": "ToolbarOverflowPopoverContent", children: children.map((item, index) => {
