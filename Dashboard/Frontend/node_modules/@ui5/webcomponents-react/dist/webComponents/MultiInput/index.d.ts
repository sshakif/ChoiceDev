...
interface MultiInputPropTypes extends MultiInputAttributes, Omit<CommonProps, keyof MultiInputAttributes | 'children' | 'icon' | 'tokens' | 'valueStateMessage' | 'onChange' | 'onClose' | 'onInput' | 'onOpen' | 'onSelectionChange' | 'onTokenDelete' | 'onValueHelpTrigger'> {
    /**
