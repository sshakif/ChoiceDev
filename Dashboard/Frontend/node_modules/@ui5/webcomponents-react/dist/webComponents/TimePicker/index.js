 ...
 */
const TimePicker = withWebComponent('ui5-time-picker', ['formatPattern', 'name', 'placeholder', 'value', 'valueState'], ['disabled', 'open', 'readonly'], ['valueStateMessage'], ['change', 'close', 'input', 'open']);
