...
import { Children, cloneElement, createRef, forwardRef, useCallback, useEffect, useMemo, useRef, useState } from 'react';
...
const Toolbar = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const toolbarClasses = clsx(classNames.outerContainer, toolbarStyle === 'Clear' && classNames.clear, active && classNames.active, design === 'Solid' && classNames.solid, design === 'Transparent' && classNames.transparent, design === 'Info' && classNames.info, className);
  ...
  const debouncedOverflowChange = useRef(undefined);
  useEffect(() => {
