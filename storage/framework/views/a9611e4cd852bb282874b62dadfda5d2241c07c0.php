					...
					<div class="col-lg-8">
						<div class="row">
							<div class="col-lg-12 col-md-6">
								<div class="single-blog-box">
									<div class="blog-thumb">
										<img src="<?php echo e(asset('/')); ?>frontend-assets/img/blog-6.png" alt="">
									</div>
							...
							<div class="col-lg-12 col-md-6">
								<div class="single-blog-box">
									<div class="blog-thumb">
										<img src="<?php echo e(asset('/')); ?>frontend-assets/img/blog-2.png" alt="">
									</div>
									<div class="blog-content">
										<div class="blog-meta">
											<span>Admin: Mera</span>
							...
							<div class="col-lg-12 col-md-6">
								<div class="single-blog-box">
									<div class="blog-thumb">
										<img src="<?php echo e(asset('/')); ?>frontend-assets/img/blog-3.png" alt="">
									</div>
									<div class="blog-content">
										<div class="blog-meta">
											<span>Admin: Mera</span>
							...
							<div class="col-lg-12 col-md-6">
								<div class="single-blog-box">
									<div class="blog-thumb">
										<img src="<?php echo e(asset('/')); ?>frontend-assets/img/blog-4.png" alt="">
									</div>
									<div class="blog-content">
										<div class="blog-meta">
											<span>Admin: Mera</span>
								...
								<div class="widget-sidber">
									...
									<div class="sidber-widget-recent-post">
										<div class="recent-widget-thumb">
											<img src="<?php echo e(asset('/')); ?>frontend-assets/img/recent-post-1.png" alt="">
										</div>
									...
									<div class="sidber-widget-recent-post">
										<div class="recent-widget-thumb">
											<img src="<?php echo e(asset('/')); ?>frontend-assets/img/recent-post-2.png" alt="">
										</div>
										<div class="recent-widget-content">
									...
									<div class="sidber-widget-recent-post">
										<div class="recent-widget-thumb">
											<img src="<?php echo e(asset('/')); ?>frontend-assets/img/recent-post-3.png" alt="">
										</div>
										<div class="recent-widget-content">
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Hybritech\ChoiceDev\resources\views/frontend/resources/index.blade.php ENDPATH**/ ?>