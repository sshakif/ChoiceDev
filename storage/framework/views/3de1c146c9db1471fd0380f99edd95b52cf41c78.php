        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-service-box">
            <div class="service-icon">
              <?php if($service->file_path && file_exists(public_path($service->file_path))): ?>
              <img src="<?php echo e(asset($service->file_path)); ?>" alt="<?php echo e($service->title); ?>">
              <?php else: ?>
              <img src="<?php echo e(asset('frontend-assets/img/default-service.png')); ?>" alt="Default Service Icon">
              <?php endif; ?>
            </div>
            <div class="service-content">
              <h4><?php echo e($service->title); ?></h4>
              <p><?php echo e(Str::limit($service->short_desc, 120)); ?></p>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Hybritech\ChoiceDev\resources\views/frontend/services/index.blade.php ENDPATH**/ ?>